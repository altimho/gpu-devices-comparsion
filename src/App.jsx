...
const tableData = [
  ...
  { gen: "M3", chip: "M3 (10-core)",    gpuCores: 10, nvLaptop: "RTX 3060 Laptop",     nvDesktop: "RTX 3060",         notes: "1-е поколение HW ray tracing" },
  ...
  { gen: "M4", chip: "M4 (10-core)",    gpuCores: 10, nvLaptop: "GTX 1650 Laptop",     nvDesktop: "GTX 1650",         notes: "Слабее M2 в играх из-за смены арх." },
  ...
  { gen: "M4", chip: "M4 Max (40-core)",gpuCores: 40, nvLaptop: "RTX 4070 Laptop",     nvDesktop: "RTX 4070 / 3080 Ti", notes: "Blender: −30% от RTX 4090" },
  { gen: "M5", chip: "M5 (10-core)",    gpuCores: 10, nvLaptop: "RTX 3050 Laptop",     nvDesktop: "GTX 1660 Ti",      notes: "Cyberpunk Low+MetalFX: 35–45 FPS" },
  { gen: "M5", chip: "M5 Pro (20-core)",gpuCores: 20, nvLaptop: "RTX 4070 Laptop",     nvDesktop: "RTX 4070",         notes: "+24–26% к M4 Pro; OpenCL ≈ RTX 4070 desktop" },
  { gen: "M5", chip: "M5 Max (40-core)",gpuCores: 40, nvLaptop: "RTX 5070 Laptop",     nvDesktop: "RTX 4070 Ti",      notes: "OpenCL: уровень RTX 5070 Laptop" },
  // ── Consoles & Other ─────────────────────────────────────────────────────
  ...
  { gen: "Other", chip: "PS5 Pro",                       gpuCores: null, nvLaptop: "RTX 5060 Ti Laptop",     nvDesktop: "RTX 5060 Ti",              notes: "RDNA 3.5, 45% быстрее PS5 (DF 2025), $699" },
  ...
  { gen: "Other", chip: "Steam Machine (гипот.)",         gpuCores: 28,  nvLaptop: "RTX 3060 Laptop",        nvDesktop: "RTX 3060 / RX 7600",       notes: "RDNA 3, 28 CU, 8GB GDDR6, SteamOS +30% vs Windows. Цена $699→$949?" },
];
...
const valueData = [
  ...
  { name: "Apple M5 (10-core)",    type: "Apple",  price: 699,  blender: 730,  note: "Mac Mini M5 2026 (ожид.)" , pcCost: 0 },
  { name: "Apple M5 Pro (20-core)",type: "Apple",  price: 1399, blender: 2600, note: "Mac Mini M5 Pro 2026 (ожид.)" , pcCost: 0 },
  // ── GTX ────────────────────────────────────────────────────────────────────
  ...
  { name: "GTX 1080",              type: "NVIDIA", price: 599,  blender: 220,  note: "MSRP 2016 — топ своего времени" , pcCost: 350 },
  { name: "GTX 1080 Ti",           type: "NVIDIA", price: 699,  blender: 290,  note: "MSRP 2017 — легендарная карта" , pcCost: 350 },
  ...
  { name: "RTX 2080 Ti",           type: "NVIDIA", price: 999,  blender: 1950, note: "MSRP 2018 — флагман Turing" , pcCost: 350 },
  // ── RTX 30xx ──────────────────────────────────────────────────────────────
  ...
  { name: "RTX 3080 10GB",        type: "NVIDIA", price: 699,  blender: 4700, note: "MSRP 2020 — народный флагман" , pcCost: 350 },
  ...
  { name: "RTX 4070 Super",       type: "NVIDIA", price: 599,  blender: 6200, note: "MSRP 2024 — лучший sweet spot 40xx" , pcCost: 350 },
  ...
  { name: "RTX 4080 Super",       type: "NVIDIA", price: 999,  blender: 10100, note: "MSRP 2024 — лучший sweet spot 40xx high-end" , pcCost: 350 },
  { name: "RTX 4090",              type: "NVIDIA", price: 1599, blender: 10880,note: "MSRP 2022 — флагман поколения" , pcCost: 350 },
  // ── RTX 50xx ──────────────────────────────────────────────────────────────
  ...
  { name: "RTX 5070 Ti",          type: "NVIDIA", price: 749,  blender: 9200, note: "MSRP 2025 — ≈ RTX 4080 за $749" , pcCost: 350 },
  { name: "RTX 5080",              type: "NVIDIA", price: 999,  blender: 9800, note: "MSRP 2025" , pcCost: 350 },
  { name: "RTX 5090",              type: "NVIDIA", price: 1999, blender: 14945,note: "MSRP 2025 — новый флагман" , pcCost: 350 },
  // ── Consoles & Framework ──────────────────────────────────────────────────
  // Blender scores for consoles are estimated/unavailable — shown as gaming performance proxy
  // Price = full device MSRP. Строки с 🔺 — обновлённые цены после подорожания
  { name: "Steam Deck OLED",               type: "Other", price: 549,  blender: 55,   note: "До подорожания (май 2026). Handheld, 800p, ~GTX 1050 Ti" , pcCost: 0 },
  { name: "Steam Deck OLED 🔺",            type: "Other", price: 789,  blender: 55,   note: "После подорожания — май 2026 (+$240). RAM/тарифный кризис" , pcCost: 0 },
  { name: "Nintendo Switch 2",             type: "Other", price: 449,  blender: 80,   note: "До подорожания. Docked, Ampere, DLSS, ~GTX 1050 Ti–1650" , pcCost: 0 },
  { name: "Nintendo Switch 2 🔺",          type: "Other", price: 499,  blender: 80,   note: "После подорожания — с 1 сент. 2026 (+$50)" , pcCost: 0 },
  { name: "Xbox Series S",                 type: "Other", price: 299,  blender: 130,  note: "RDNA 2, 4 TFLOPS, ~GTX 1660 Super" , pcCost: 0 },
  { name: "PS5 / Xbox Series X",           type: "Other", price: 499,  blender: 1900, note: "RDNA 2, ~RTX 3060 Ti — оптимизация консоли" , pcCost: 0 },
  { name: "PS5 Pro",                       type: "Other", price: 699,  blender: 3200, note: "До подорожания. RDNA 3.5, ~RTX 5060 Ti (DF 2025)" , pcCost: 0 },
  { name: "PS5 Pro 🔺",                    type: "Other", price: 899,  blender: 3200, note: "После подорожания Sony 2026 (+$200)" , pcCost: 0 },
  { name: "Steam Machine (гипот.)",        type: "Other", price: 699,  blender: 1500, note: "Оценка до кризиса (LTT). RDNA 3, 28 CU, ~RX 7600, SteamOS" , pcCost: 0 },
  { name: "Steam Machine 🔺 (гипот.)",     type: "Other", price: 949,  blender: 1500, note: "Оценка после кризиса RAM/тарифов 2026. Не анонсирована официально" , pcCost: 0 },
  { name: "Framework Desktop (AI Max 385)",type: "Other", price: 1099, blender: 1800, note: "Radeon 8050S, весь компьютер без ОС/SSD" , pcCost: 0 },
  { name: "Framework Desktop (AI Max+ 395)",type:"Other", price: 1699, blender: 1900, note: "Radeon 8060S, весь компьютер без ОС/SSD" , pcCost: 0 },
];
  ...
  return (
    <>
            ...
            <thead>
              <tr style={{ borderBottom:"1px solid #1e1e36" }}>
                ...
                <th className="col-header" onClick={() => toggleSort("chip")}>
                  Чип <SortIcon active={sort.key==="chip"} dir={sort.dir} />
                </th>
                <th className="col-header" onClick={() => toggleSort("gpuCores")} style={{ textAlign:"center" }}>
                  GPU ядра <SortIcon active={sort.key==="gpuCores"} dir={sort.dir} />
                </th>
                <th className="col-header" onClick={() => toggleSort("nvLaptop")}>
                  NVIDIA (ноутбук) <SortIcon active={sort.key==="nvLaptop"} dir={sort.dir} />
                </th>
                <th className="col-header" onClick={() => toggleSort("nvDesktop")}>
                  NVIDIA (десктоп) <SortIcon active={sort.key==="nvDesktop"} dir={sort.dir} />
                </th>
                <th className="col-header">Заметки</th>
              </tr>
            </thead>
            <tbody>
              {filtered.length === 0 && (
                <tr><td colSpan={6} style={{ padding:32, textAlign:"center", color:"#475569", fontSize:13 }}>Ничего не найдено</td></tr>
              )}
              {filtered.map((row, i) => {
      ...
      <div style={{ display:"flex", gap:20, flexWrap:"wrap", alignItems:"center", marginTop:16 }}>
        ...
        <span style={{ marginLeft:"auto", fontSize:11, color:"#334155" }}>* Нативные Metal-игры, 1080p. Приблизительные данные.</span>
      </div>
    </>
  );
}
...
function ValueTab() {
  ...
  return (
    <>
      {/* Controls */}
      <div style={{ display:"flex", alignItems:"center", gap:12, flexWrap:"wrap", marginBottom:20 }}>
        <div style={{ fontSize:12, color:"#475569", letterSpacing:"0.05em" }}>Фильтр:</div>
        ...
        <span style={{ marginLeft:"auto", fontSize:11, color:"#334155" }}>
          ⚠ Metal (Apple) ≠ CUDA (NVIDIA) — API разные
        </span>
      </div>
            ...
            <thead>
              <tr style={{ borderBottom:"1px solid #1e1e36" }}>
                ...
                <th className="col-header" onClick={() => toggleSort("name")}>
                  Устройство <SortIcon active={sortKey==="name"} dir={sortDir} />
                </th>
                <th className="col-header" onClick={() => toggleSort("type")}>
                  Тип <SortIcon active={sortKey==="type"} dir={sortDir} />
                </th>
                <th className="col-header" onClick={() => toggleSort("price")} style={{ textAlign:"right" }}>
                  GPU / Устройство <SortIcon active={sortKey==="price"} dir={sortDir} />
                </th>
                <th className="col-header" style={{ textAlign:"right", cursor:"default", color:"#475569" }}>+ ПК</th>
                <th className="col-header" onClick={() => toggleSort("totalPrice")} style={{ textAlign:"right" }}>
                  Итого <SortIcon active={sortKey==="totalPrice"} dir={sortDir} />
                </th>
                ...
                <th className="col-header" onClick={() => toggleSort("efficiency")} style={{ minWidth:200 }}>
                  Эффективность (pts/$) <SortIcon active={sortKey==="efficiency"} dir={sortDir} />
                </th>
                <th className="col-header" style={{ cursor:"default" }}>Ценник</th>
              </tr>
            </thead>
            <tbody>
              {sorted.map((row, i) => {
                  ...
                  <tr key={row.name} className="row-hover" style={{
                    ...
                    <td style={{ padding:"10px 12px" }}>
                      <span style={{
                        ...
                        {row.price < 400 ? "Бюджет" : row.price < 800 ? "Средний" : "Премиум"}
                      </span>
                    </td>
                  </tr>
                );
      ...
      <div style={{ marginTop:14, fontSize:11, color:"#334155", lineHeight:1.6 }}>
        Blender Open Data (Metal для Apple, OptiX/CUDA для NVIDIA). NVIDIA: цена GPU + $350 (минимальный билд: CPU+мат.плата+16GB RAM+500GB SSD). Apple/консоли/Framework: полная цена устройства.<br />
        Apple: полная цена Mac Mini (компьютер). NVIDIA: только цена видеокарты. Прямое сравнение условно.
      </div>
    </>
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth:1140, margin:"0 auto 24px" }}>
        ...
        <p style={{ color:"#64748b", fontSize:13, margin:0 }}>Сравнение и эффективность GPU</p>
      </div>

      {/* Tabs */}
      <div style={{ maxWidth:1140, margin:"0 auto 24px", display:"flex", gap:8 }}>
        {[["compare","⇆ Соответствие"],["value","$ Эффективность"]].map(([key,label]) => (
      ...
      <div style={{ maxWidth:1140, margin:"0 auto" }}>
        {tab === "compare" ? <CompareTab /> : <ValueTab />}
      </div>
    </div>
  );
}
